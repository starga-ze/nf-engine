    ...
    while (true) {
        ...
        if (n > 0) {
            ...
            while (true) {
                ...
                TcpFramingResult result = TcpFraming::tryExtractFrame(rxBuffer, payload, bodyLen);

                if (result == TcpFramingResult::NeedMoreData)
                {
                    break;
                }

                if (result == TcpFramingResult::InvalidBodyLen)
                {
